...
/**
 * Privacy Subsystem implementation for block_enrolmenttimer.
 *
...
class provider implements \core_privacy\local\metadata\provider, \core_privacy\local\request\plugin\provider {
    ...
    /**
     * Returns information about how block_enrolmenttimer stores its data.
     *
    ...
    public static function get_metadata(collection $collection) : collection {
        $collection->add_database_table(
            ...
            [
                'coursename' => 'privacy:metadata:block_enrolmenttimer:enrolid',
                'coursedescription' => 'privacy:metadata:block_enrolmenttimer:alerttime',
                'courseurl' => 'privacy:metadata:block_enrolmenttimer:sent',
            ],
    ...
    public static function get_contexts_for_userid(int $userid) : contextlist {
        ...
        // The block_enrolmenttimer data is associated at the user enrolment level, so retrieve the user's enrolment id's.

        // TODO: get the data.
        $sql = "SELECT c.id
                  FROM {block_enrolmenttimer} bc
